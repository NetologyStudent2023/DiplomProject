...
//&НаСервере
//Процедура АнализГрафикаНаСервере()
////	Форма = Документы.ВКМ_ГрафикОтпусков.ПолучитьФорму("ФормаАнализГрафика", ЭтотОбъект);
////	Форма.
//КонецПроцедуры
